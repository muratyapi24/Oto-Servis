...
CREATE TABLE "PlanFeature" (
    ...
    "starterValue" VARCHAR(255) NOT NULL,
    "professionalValue" VARCHAR(255) NOT NULL,
    "enterpriseValue" VARCHAR(255) NOT NULL,
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ServiceOrder" (
    ...
    "approvalTokenExpiry" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "ServiceOrder_approvalToken_key" ON "ServiceOrder"("approvalToken");
...
-- CreateIndex
CREATE INDEX "SystemNotification_tenantId_idx" ON "SystemNotification"("tenantId");
...
-- CreateIndex
CREATE INDEX "Document_serviceOrderId_idx" ON "Document"("serviceOrderId");

-- CreateIndex
CREATE INDEX "Document_vehicleId_idx" ON "Document"("vehicleId");

-- CreateIndex
CREATE INDEX "InspectionForm_tenantId_idx" ON "InspectionForm"("tenantId");

-- CreateIndex
CREATE INDEX "InspectionForm_serviceOrderId_idx" ON "InspectionForm"("serviceOrderId");

-- CreateIndex
CREATE INDEX "CommissionRule_tenantId_idx" ON "CommissionRule"("tenantId");

-- CreateIndex
CREATE INDEX "CommissionRule_mechanicId_idx" ON "CommissionRule"("mechanicId");

-- CreateIndex
CREATE INDEX "WorkLog_tenantId_idx" ON "WorkLog"("tenantId");

-- CreateIndex
CREATE INDEX "WorkLog_mechanicId_idx" ON "WorkLog"("mechanicId");

-- CreateIndex
CREATE INDEX "WorkLog_serviceOrderId_idx" ON "WorkLog"("serviceOrderId");
...
-- AddForeignKey
ALTER TABLE "SystemNotification" ADD CONSTRAINT "SystemNotification_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Document" ADD CONSTRAINT "Document_serviceOrderId_fkey" FOREIGN KEY ("serviceOrderId") REFERENCES "ServiceOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InspectionForm" ADD CONSTRAINT "InspectionForm_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InspectionForm" ADD CONSTRAINT "InspectionForm_serviceOrderId_fkey" FOREIGN KEY ("serviceOrderId") REFERENCES "ServiceOrder"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InspectionForm" ADD CONSTRAINT "InspectionForm_mechanicId_fkey" FOREIGN KEY ("mechanicId") REFERENCES "Mechanic"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CommissionRule" ADD CONSTRAINT "CommissionRule_mechanicId_fkey" FOREIGN KEY ("mechanicId") REFERENCES "Mechanic"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WorkLog" ADD CONSTRAINT "WorkLog_mechanicId_fkey" FOREIGN KEY ("mechanicId") REFERENCES "Mechanic"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkLog" ADD CONSTRAINT "WorkLog_serviceOrderId_fkey" FOREIGN KEY ("serviceOrderId") REFERENCES "ServiceOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
