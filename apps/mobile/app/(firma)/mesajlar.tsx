...
const MOCK_THREADS: Thread[] = [
  {
    ...
    lastName: "Yılmaz",
    role: "Usta",
    lastMessage: "34 ABC 123 plakalı araç için yağ filtresi lazım, stokta var mı?",
    time: "10:42",
    unreadCount: 2,
  },
  {
    ...
    lastName: "Kaya",
    role: "Müşteri",
    lastMessage: "Aracım ne zaman hazır olacak? Akşama kadar lazım.",
    time: "09:15",
    unreadCount: 1,
  },
  {
    ...
    lastName: "Demir",
    role: "Müşteri",
    lastMessage: "Teşekkürler, harika bir hizmet aldım.",
    time: "Dün",
    unreadCount: 0,
  },
  {
    ...
    lastName: "Çelik",
    role: "Usta",
    lastMessage: "Fren balatası değişimi tamamlandı, test sürüşü yapıyorum.",
    time: "Dün",
    unreadCount: 0,
  },
];
      ...
      >
        {MOCK_THREADS.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyBody}>Henüz bir konuşmanız bulunmuyor.</Text>
          </View>
        ) : (
