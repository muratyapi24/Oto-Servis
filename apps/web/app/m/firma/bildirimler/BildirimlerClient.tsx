...
export default function BildirimlerClient() {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/mobile/firma/bildirimler");
  ...
  async function markAsRead(id: string) {
    ...
    await fetch(`/api/mobile/firma/bildirimler/${id}/oku`, { method: "PATCH" });
  }

  async function markAllAsRead() {
    setMarkingAll(true);
    try {
      await fetch("/api/mobile/firma/bildirimler", { method: "PATCH" });
