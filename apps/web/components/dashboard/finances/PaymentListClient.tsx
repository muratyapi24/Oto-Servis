              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((payment) => (
                  <tr key={payment.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 font-medium text-slate-700">{getCustomerName(payment.customer)}</td>
                    <td className="px-6 py-4 text-slate-600">{payment.invoice?.invoiceNumber ?? "-"}</td>
                    ...
                    <td className="px-6 py-4 text-slate-600">{dayjs(payment.paymentDate).format("DD MMM YYYY")}</td>
                  </tr>
                ))
              )}
            </tbody>
