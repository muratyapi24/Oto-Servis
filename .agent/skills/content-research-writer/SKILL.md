...
3. **Conduct Research**
   ...
   Citations:
   [1] McKinsey Global Institute. (2026). "The Economic Potential 
       of Generative AI"
   [2] Stack Overflow Developer Survey (2026)
   [3] Smith, J. (2026). MIT Technology Review interview
...
7. **Citation Management**
   ...
   **Inline Citations**:
   ```markdown
   Studies show 40% productivity improvement (McKinsey, 2026).
   ```
   ...
   **Numbered References**:
   ...
   [1] McKinsey Global Institute. (2026)...
   ```
