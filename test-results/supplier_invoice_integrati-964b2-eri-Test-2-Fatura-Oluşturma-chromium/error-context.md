...
- Name: supplier_invoice_integration.test.ts >> Firma Platformu Entegrasyon Testleri >> Test 2: Fatura Oluşturma
- Location: testsprite_tests\integration\supplier_invoice_integration.test.ts:56:7
...
Call log:
  - waiting for locator('button:has-text("Stok Alımı Yap")')
        ...
        - generic [ref=e48]:
          - generic [ref=e49]:
            - link [ref=e50] [cursor=pointer]:
              ...
              - img [ref=e51]
            - generic [ref=e53]:
              - heading "Stok Alım Faturaları" [level=1] [ref=e54]:
                - img [ref=e55]
                - text: Stok Alım Faturaları
              - paragraph [ref=e59]: Tedarikçilerden alınan ürünlerin fatura ve irsaliye kayıtları.
          - button "Stok Girişi Yap" [ref=e60]:
            - img [ref=e61]
            - text: Stok Girişi Yap
        - generic [ref=e65]:
          - img [ref=e66]
          - text: "Yetkilendirme hatası: oturum bulunamadı."
  - alert [ref=e68]
