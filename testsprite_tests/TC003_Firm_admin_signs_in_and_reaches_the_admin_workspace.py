...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Giriş Yap' link to open the desktop login route so the admin sign-in form can be filled.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/nav/div/div[3]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the email and password fields with the firm admin credentials and submit the login form.
        frame = context.pages[-1]
        # Input text
